# I COPIED THIS FROM A RANDOM REPO. DO NOT USE IT
"""Turn a photo into ascii.svg — a monochrome ASCII portrait.
...
def build_svg(lines, cols=COLS):
    ...
    for i, line in enumerate(lines):
        ...
        safe = (line.replace("&", "&amp;").replace("<", "&lt;")
                    .replace(">", "&gt;"))
        p.append(f'<text xml:space="preserve" x="{pad}" y="{y + 11.2:.1f}" '
